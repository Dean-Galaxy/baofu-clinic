...
export default function BaofuClinicTool() {
  ...
  return (
    <main className="tool-page">
      <header className="topbar">
        <Link className="brand" href="/" aria-label="返回 AI 工具箱首页">
      ...
      <section className="hero" id="top">
        <div className="tool-breadcrumb"><Link href="/">工具箱</Link><span>/</span><strong>包袱诊断室</strong></div>
      ...
      <footer>
        <div><strong>AI 工具箱 · 包袱诊断室</strong><span>让改稿有依据，让笑点有结构。</span></div>
